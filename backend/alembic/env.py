...
Imports the ORM ``Base`` and all models so that ``target_metadata`` reflects
the full schema.  The database URL is pulled from ``app.core.config.settings``
at runtime, overriding whatever is in *alembic.ini*.
"""
